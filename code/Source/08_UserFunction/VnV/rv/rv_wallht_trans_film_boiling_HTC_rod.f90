!
      SUBROUTINE trans_film_boiling_HTC_rod(i,mode,quala,p,alphag,alphal,rhog,rhol,tg,tl,vg,vl,condg,condl,visg,visl,cpg,cpl,betag,betal)
!
...
!                   
      c1=DMIN1(1.d0,DMAX1(1.2516d0*(0.999-alphag),0.d0))    !  1/(0.999-0.2) = 1.2516                                                
      IF(c1.lt.1.d0)THEN
         c2=(alphag-0.2d0) * 1.2516d0                                                         
...
!
      IF(tl.ge.tsat_t-0.05d0)mode=mode+1
!      
      RETURN     
      END SUBROUTINE trans_film_boiling_HTC_rod
!
