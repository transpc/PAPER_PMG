!
      SUBROUTINE udfn_horizontal_outlet
!
...
!
         IF(l_horizontal_outlet_init.eq..TRUE.)l_horizontal_outlet_init=.FALSE.      
!      
...
!
      ...
      ENDDO
!      
      END SUBROUTINE udfn_horizontal_outlet
!
