!
      SUBROUTINE trans_film_reflood_HTC(i,mode)
!
...
!      drho=DMAX1(1.0d-7,drho)
      drho=DMAX1(1.0d-7,cell%rhol(i)-cell%rhog(i))
...
!      HTC_brom=0.62d0*(gravity*cond**3*cell%rhog(i)*drho*(hfg+0.5d0*cp*dt_sat)/(viscos*dt_sat))**0.25d0
      ...
      HTC_fb_min=HTC_fb_l*DMAX1(0.0d0,0.999d0-cell%alphag(i))
!
!.....Forslund-Rohsenow correlation
!      
      d=3.0d0*sigma/(cell%rhog(i)*DMAX1(0.01,vfg**2))  ! yjm
      d=DMIN1(3.d-3,DMAX1(1.d-4,d))
      HTC_fr=0.1d0*pi*(6.0d0*(0.999d0-cell%alphag(i))/pi)**0.66666666d0
      HTC_fr=HTC_fr*(gravity*rho*cell%rhol(i)*hfg*cond**3/(dt_sat*viscos*d*(pi/6.d0)**0.33333333d0))**0.25d0   !!!cyj mod. bug fix
!
      reygas=DABS(cell%alphag(i)*cell%rhog(i)*ug_o(i))*dh/cell%lviscosg(i)
...
!      
      ...
      HTC_fbb=DMAX1(0.0d0,(1400.d0-1880.d0*zqf_min))*DMIN1(0.5d0,0.999d0-cell%alphag(i))+DSQRT(1.0d0-cell%alphag(i))*HTC_brom/zqf_min**0.25d0  ! yjm
!
      IF(cell%alphag(i).ge.0.9d0)THEN
         HTC_fbb=HTC_fr
      ELSEIF(cell%alphag(i).ge.0.6d0)THEN
         xmf=(0.9d0-cell%alphag(i))/(0.9d0-0.6d0)
         xmf=xmf*(2.0d0-xmf)
...
!     
      ...
      d_max=DSQRT(cell%alphal(i))*dia_rod
...
!      HTC_tgp=0.0d0 
!
      END SUBROUTINE trans_film_reflood_HTC
