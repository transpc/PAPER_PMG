!
      SUBROUTINE convert_temp2erg(pi,tli,tgi,qualai,eli,egi,rholi,rhogi,pps_oi,estm_oi, &
...
!
!.....Input
      REAL(8) pi,tli,tgi,qualai
      REAL(8) taoi,cvaoi,uaoi,dcvai,rai
!.....Output
      REAL(8) eli,egi,rholi,rhogi
...
!      
      EQUIVALENCE(s( 1),tsat),    &
                 ...
                 (s(26),entgs)
!
      DATA SHL,SSS/.FALSE.,.FALSE./   !ACTUAL   
!      DATA SHL,SSS/.TRUE.,.TRUE./    !TEST 
...
!........Superheated liquid -> saturated       
      ...
      ENDIF       
! 
      END SUBROUTINE convert_temp2erg
!-------------------------------------------------------------------------------------------
      FUNCTION saturation_temperature(pi)
!
      USE STM_TBL_cupid  , ONLY: st_tbl,          &
                                 nt,ndxstd,nfluid
!      
