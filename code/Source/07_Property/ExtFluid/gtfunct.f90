      FUNCTION gtfunct_cupid(deltapres,deltatemp,tables,ptr) 
!define win32dvf                                                        
!define erf                                                             
!define fourbyt                                                         
!define hconden                                                         
...
! 20   continue                                                         
!                                                                       
      gtfunct_cupid=deltapres(1)*(tables(ptr+2) * 1.0d0*deltatemp(1)+tables(  &
      ptr+3) * 2.0d0*deltatemp(2)+tables(ptr+4) * 3.0d0*deltatemp(3)+   &
      tables(ptr+5) * 4.0d0*deltatemp(4)+tables(ptr+6) * 5.0d0*         &
      deltatemp(5))+deltapres(2)*(tables(ptr+8) * 1.0d0*deltatemp(1)+   &
      tables(ptr+9) * 2.0d0*deltatemp(2)+tables(ptr+10) * 3.0d0*        &
      deltatemp(3)+tables(ptr+11) * 4.0d0*deltatemp(4)+tables(ptr+12) * &
      5.0d0*deltatemp(5))+deltapres(3)*(tables(ptr+14) * 1.0d0*         &
      deltatemp(1)+tables(ptr+15) * 2.0d0*deltatemp(2)+tables(ptr+16) * &
      3.0d0*deltatemp(3)+tables(ptr+17) * 4.0d0*deltatemp(4)+tables(ptr+&
      18) * 5.0d0*deltatemp(5))                                         
      gtfunct_cupid=gtfunct_cupid+deltapres(4)*(tables(ptr+20) * 1.0d0*deltatemp(1)+&
      tables(ptr+21) * 2.0d0*deltatemp(2)+tables(ptr+22) * 3.0d0*       &
      deltatemp(3)+tables(ptr+23) * 4.0d0*deltatemp(4)+tables(ptr+24) * &
      5.0d0*deltatemp(5))+deltapres(5)*(tables(ptr+26) * 1.0d0*         &
      deltatemp(1)+tables(ptr+27) * 2.0d0*deltatemp(2)+tables(ptr+28) * &
      3.0d0*deltatemp(3)+tables(ptr+29) * 4.0d0*deltatemp(4)+tables(ptr+&
      30) * 5.0d0*deltatemp(5))+deltapres(6)*(tables(ptr+32) * 1.0d0*   &
      deltatemp(1)+tables(ptr+33) * 2.0d0*deltatemp(2)+tables(ptr+34) * &
      3.0d0*deltatemp(3)+tables(ptr+35) * 4.0d0*deltatemp(4)+tables(ptr+&
      36) * 5.0d0*deltatemp(5))                                         
      RETURN 
      END FUNCTION gtfunct_cupid                          
