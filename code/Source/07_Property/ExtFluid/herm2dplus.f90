      SUBROUTINE herm2dplus_cupid(tables,ptr,a,arg,g,t,p,err) 
!define win32dvf                                                        
!define erf                                                             
!define fourbyt                                                         
!define hconden                                                         
...
!deck herm2dplus                                                        
!                                                                       
!  $Id: herm2dplus.ff,v 1.1 2001/02/01 23:15:49 r5qa Exp dbarber $      
!                                                                       
...
!      integer ip, jt                                                   
!endif                                                                  
      REAL(8) x,x2,y,y1,gfunct_cupid,gtfunct_cupid,gttfunct_cupid,gpfunct_cupid,gptfunct_cupid 
!    &      gtttfunct                                                   
!           randy1,randy2,randy3,                                       
!    &      randy4,randy5,randy6,randy7,diff1,diff2,diff3,diff4,diff5,  
!    &      diff6,diff7                                                 
!if def,swesty                                                          
!      real psi0,psi1,psi2,dgdtii,dgdtij,dgdtji,                        
...
!    &      gjittpp,gjjttpp                                             
!endif                                                                  
      REAL(8) a,deltt,deltp,gtilde,dgtildedt,dgtildedp,d2gtildedt2,     &
      d2gtildedpdt,g,p,pii,pij,pji,pjj,tii,tij,tji,tjj,t                
!if def,swesty                                                          
!      real psi0x,psi1x,psi2x,dpsi0x,dpsi1x,dpsi2x,d2psi0x,             
!    &      d2psi1x,d2psi2x,d3psi0x,d3psi1x,d3psi2x,                    
!    &      psi0x2,psi1x2,psi2x2,dpsi0x2,dpsi1x2,dpsi2x2,d2psi0x2,      
!    &      d2psi1x2,d2psi2x2,d3psi0x2,d3psi1x2,d3psi2x2,               
!    &      psi0y,psi1y,psi2y,dpsi0y,dpsi1y,dpsi2y,d2psi0y,             
!    &      d2psi1y,d2psi2y,d3psi0y,d3psi1y,d3psi2y,                    
!    &      psi0y1,psi1y1,psi2y1,dpsi0y1,dpsi1y1,dpsi2y1,d2psi0y1,      
!    &      d2psi1y1,d2psi2y1,d3psi0y1,d3psi1y1,d3psi2y1                
!endif                                                                  
...
!           IF(myrank.eq.0)write(80,*) gtilde,randy1,diff1,x,y,p,t                    
!         endif                                                         
!       endif                                                           
!***********************************************************************
...
!           IF(myrank.eq.0)write(81,*) dgtildedt,randy2,diff2,x,y,p,t                 
!         endif                                                         
!       endif                                                           
!***********************************************************************
...
!           IF(myrank.eq.0)write(82,*) dgtildedp,randy3,diff3,x,y,p,t                 
!         endif                                                         
!       endif                                                           
!***********************************************************************
...
!           IF(myrank.eq.0)write(83,*) d2gtildedt2,randy4,diff4,x,y,p,t               
!         endif                                                         
!       endif                                                           
!***********************************************************************
...
!endif                                                                  
!       if (arg .eq. 'liquid') then                                     
!         randy5 = gptfunct(y,x,c)                                      
!         randy5 = randy5/(deltp*deltt)                                 
!if -def,swesty                                                         
      d2gtildedpdt=gptfunct_cupid(yy,xx,tables,ptr) 
      d2gtildedpdt=d2gtildedpdt/(deltp*deltt) 
!endif                                                                  
!         if (abs ((d2gtildedpdt-randy5)/d2gtildedpdt) .gt. diff5) then 
!           diff5 = abs ((d2gtildedpdt-randy5)/d2gtildedpdt)            
!           IF(myrank.eq.0)write(84,*) d2gtildedpdt,randy5,diff5,x,y,p,t              
!         endif                                                         
!       endif                                                           
!***********************************************************************
...
!endif                                                                  
!       if (arg .eq. 'liquid') then                                     
!         randy6 = gtttfunct(y,x,c)                                     
!         randy6 = randy6/deltt**3                                      
!if -def,swesty                                                         
!      d3gtildedt3 = gtttfunct(yy,xx,tables,ptr)                        
!      d3gtildedt3 = d3gtildedt3/deltt**3                               
!endif                                                                  
!         if (abs ((d3gtildedt3-randy6)/d3gtildedt3) .gt. diff6) then   
!           diff6 = abs ((d3gtildedt3-randy6)/d3gtildedt3)              
!           IF(myrank.eq.0)write(85,*) d3gtildedt3,randy6,diff6,x,y,p,t               
!         endif                                                         
!       endif                                                           
!***********************************************************************
! calculate d3(gtilde)/dpdt2                                            
!if def,swesty                                                          
...
!endif                                                                  
!       if (arg .eq. 'liquid') then                                     
!         randy7 = gpttfunct(y,x,c)                                     
!         randy7 = randy7/(deltt**2*deltp)                              
!if -def,swesty                                                         
!      d3gtildedpdt2 = gpttfunct(yy,xx,tables,ptr)                      
!      d3gtildedpdt2 = d3gtildedpdt2/(deltt**2*deltp)                   
!endif                                                                  
!         if (abs ((d3gtildedpdt2-randy7)/d3gtildedpdt2) .gt.           
!    &        diff7) then                                               
!           diff7 = abs ((d3gtildedpdt2-randy7)/d3gtildedpdt2)          
!           IF(myrank.eq.0)write(86,*) d3gtildedpdt2,randy7,diff7,x,y,p,t             
!         endif                                                         
!       endif                                                           
!***********************************************************************
...
!      g(10) = d3gtildedt3                                              
!***********************************************************************
!      call timstop ('herm2dplus')                                      
      RETURN 
      END SUBROUTINE herm2dplus_cupid                     
