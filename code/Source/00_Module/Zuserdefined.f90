...
!      LOGICAL l_horizontal_outlet_init !with l_horizontal_outlet
      ...
      LOGICAL udfl_hflux_bc_profile       !¿‘∑¬, set_wall_heat_fluxøÕ «‘≤≤√≥∏Æ      
...
!.....momentum transfer      
      ...
      LOGICAL udfl_mom_wall               !wall frcition ∏µ®, wall_dragø‹¿« ∏µ® ªÁøÎΩ√, wall_dragø°º≠ vv_prob ¡¶∞≈«“ ∞Õ
...
!
      LOGICAL :: MG_solver
!.....ÏïïÎ†• ÏÜîÎ≤ÑÎ°ú hypre(BiCGSTAB+BoomerAMG) Í≤ΩÎ°úÎ•º Ïì∏ÏßÄ. MG_solver=.true. Î•º
!     Ï†ÑÏ†úÎ°ú ÌïúÎã§ ‚Äî CSR¬∑Ìó§ÏùºÎ°ú¬∑Î∂ÑÌï† Ïû¨Î≤àÌò∏Í∞Ä PMG prep Ï≤¥Ïù∏Ïùò ÏÇ∞Î¨ºÏù¥Îã§.
